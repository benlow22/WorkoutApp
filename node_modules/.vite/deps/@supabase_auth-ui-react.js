...
var x = (e3, t2, n2, r2, i2) => {
  ...
  const a2 = (e4, t3, n3) => {
    ...
    const p2 = (e5) => {
      for (c2 in e5) {
        const x3 = 64 === c2.charCodeAt(0), z3 = x3 && Array.isArray(e5[c2]) ? e5[c2] : [e5[c2]];
        for (d2 of z3) {
          const e6 = /[A-Z]/.test(S2 = c2) ? S2 : S2.replace(/-[^]/g, (e7) => e7[1].toUpperCase()), z4 = "object" == typeof d2 && d2 && d2.toString === $ && (!r2.utils[e6] || !t3.length);
          if (e6 in r2.utils && !z4) {
          ...
          if (x3 && (u2 = c2.slice(1) in r2.media ? "@media " + r2.media[c2.slice(1)] : c2, c2 = u2.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (e7, t4, n4, r3, i3, o3) => {
            ...
            const e7 = x3 ? n3.concat(c2) : [...n3], r3 = x3 ? [...t3] : m(t3, c2.split(B));
            void 0 !== o2 && i2(I(...o2)), o2 = void 0, a2(d2, r3, e7);
          } else
            void 0 === o2 && (o2 = [[], t3, n3]), c2 = x3 || 36 !== c2.charCodeAt(0) ? c2 : `--${k(r2.prefix)}${c2.slice(1).replace(/\$/g, "-")}`, d2 = z4 ? d2 : "number" == typeof d2 ? d2 && e6 in R ? String(d2) + "px" : String(d2) : y(b(e6, null == d2 ? "" : d2), r2.prefix, r2.themeMap[e6]), o2[0].push(`${x3 ? `${c2} ` : `${g(c2)}:`}${d2}`);
        }
      }
      var u2, S2;
    };
  ...
  const [r2, i2, o2, l2] = O(t2.composers), c2 = "function" == typeof t2.type || t2.type.$$typeof ? ((e4) => {
    ...
    for (const e4 in o2)
      if (delete p3[e4], e4 in s2) {
        let t3 = s2[e4];
        "object" == typeof t3 && t3 ? u2[e4] = { "@initial": o2[e4], ...t3 } : (t3 = String(t3), u2[e4] = "undefined" !== t3 || l2.has(e4) ? t3 : o2[e4]);
      } else
        u2[e4] = o2[e4];
    ...
    for (const [r3, i3, o3, l3] of t2.composers) {
      ...
      const t3 = A(o3, u2, e3.media), s3 = A(l3, u2, e3.media, true);
      for (const i4 of t3)
        if (void 0 !== i4)
      ...
      for (const t4 of s3)
        if (void 0 !== t4)
          for (const [i4, o4] of t4) {
            const t5 = `${r3}-${W(o4)}-${i4}`;
            h3.add(t5), n2.rules.allvar.cache.has(t5) || (n2.rules.allvar.cache.add(t5), x(o4, [`.${t5}`], [], e3, (e4) => {
              d2.allvar.apply(e4);
            }));
          }
    }
    if ("object" == typeof a2 && a2) {
      ...
      h3.add(t3), n2.rules.inline.cache.has(t3) || (n2.rules.inline.cache.add(t3), x(a2, [`.${t3}`], [], e3, (e4) => {
        d2.inline.apply(e4);
      }));
    }
    for (const e4 of String(s2.className || "").trim().split(/\s+/))
      e4 && h3.add(e4);
    const f2 = p3.className = [...h3].join(" ");
...
var B2 = ({ children: s2, appearance: t2, ...r2 }) => {
  var l2;
  const o2 = generateClassNames(
    "anchor",
    i1(),
    t2
  );
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.anchor,
      className: o2.join(" ")
    },
    s2
  );
...
var $2 = ({
  ...
  return import_react.default.createElement(
    ...
    {
      ...w2,
      style: (d2 = r2 == null ? void 0 : r2.style) == null ? void 0 : d2.button,
      className: f2.join(" "),
      disabled: l2
    },
    o2,
...
var M2 = ({
  ...
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.container,
      className: o2.join(" ")
    },
    s2
  );
...
var g1 = ({
  ...
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.divider,
      className: o2.join(" ")
    }
  );
};
...
var H2 = ({ children: s2, appearance: t2, ...r2 }) => {
  var l2;
  const o2 = generateClassNames(
    "input",
    h1({
      type: r2.type === "password" ? "password" : "default"
    }),
    t2
  );
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.input,
      className: o2.join(" ")
    },
    s2
  );
...
var D2 = ({ children: s2, appearance: t2, ...r2 }) => {
  var l2;
  const o2 = generateClassNames(
    "label",
    f1(),
  ...
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.label,
      className: o2.join(" ")
    },
    s2
  );
...
var z2 = ({
  ...
  return import_react.default.createElement(
    ...
    {
      ...r2,
      style: (l2 = t2 == null ? void 0 : t2.style) == null ? void 0 : l2.message,
      className: o2.join(" ")
    },
    s2
  );
...
function K({
  ...
  var E2;
  const [f2, d2] = (0, import_react.useState)(""), [c2, u2] = (0, import_react.useState)(""), [m2, i2] = (0, import_react.useState)(""), [a2, g2] = (0, import_react.useState)(false), _2 = async (C2) => {
    var b2;
    C2.preventDefault(), u2(""), i2(""), g2(true);
    const { error: L2 } = await t2.auth.signInWithOtp({
      email: f2,
      options: { emailRedirectTo: r2 }
    });
    L2 ? u2(L2.message) : i2((b2 = o2 == null ? void 0 : o2.magic_link) == null ? void 0 : b2.confirmation_text), g2(false);
  }, n2 = o2 == null ? void 0 : o2.magic_link;
  return import_react.default.createElement("form", { id: "auth-magic-link", onSubmit: _2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: l2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: l2 }, import_react.default.createElement("div", null, import_react.default.createElement(D2, { htmlFor: "email", appearance: l2 }, n2 == null ? void 0 : n2.email_input_label), import_react.default.createElement(
    H2,
    {
      id: "email",
      name: "email",
      type: "email",
      autoFocus: true,
      placeholder: n2 == null ? void 0 : n2.email_input_placeholder,
      onChange: (C2) => d2(C2.target.value),
      appearance: l2
    }
    ...
    a2 ? n2 == null ? void 0 : n2.loading_button_label : n2 == null ? void 0 : n2.button_label
  )), w2 && import_react.default.createElement(
    B2,
    {
      href: "#auth-sign-in",
      onClick: (C2) => {
        C2.preventDefault(), s2(VIEWS.SIGN_IN);
      },
      appearance: l2
    },
    (E2 = o2 == null ? void 0 : o2.sign_in) == null ? void 0 : E2.link_text
  ), m2 && import_react.default.createElement(z2, { appearance: l2 }, m2), c2 && import_react.default.createElement(z2, { color: "danger", appearance: l2 }, c2)));
}
var x2 = _({
  width: "21px",
  height: "21px"
});
var E1 = () => import_react.default.createElement(
  "svg",
  {
    className: x2(),
...
var w1 = () => import_react.default.createElement(
  "svg",
  {
    className: x2(),
    xmlns: "http://www.w3.org/2000/svg",
...
var x1 = () => import_react.default.createElement(
  "svg",
  {
    className: x2(),
    fill: "gray",
...
var _1 = () => import_react.default.createElement(
  "svg",
  {
    className: x2(),
    xmlns: "http://www.w3.org/2000/svg",
...
function D1({
  supabaseClient: s2,
  socialLayout: t2 = "vertical",
  providers: r2 = ["github", "google", "azure"],
  redirectTo: o2,
  onlyThirdPartyProviders: l2 = true,
  view: w2 = "sign_in",
  i18n: f2,
  appearance: d2
}) {
  const [c2, u2] = (0, import_react.useState)(false), [m2, i2] = (0, import_react.useState)(""), a2 = t2 === "vertical", g2 = async (n2) => {
    u2(true);
    const { error: E2 } = await s2.auth.signInWithOAuth({
      provider: n2,
      options: { redirectTo: o2 }
    });
    E2 && i2(E2.message), u2(false);
  };
  function _2(n2) {
    const E2 = n2.toLowerCase();
    return n2.charAt(0).toUpperCase() + E2.slice(1);
  }
  return import_react.default.createElement(import_react.default.Fragment, null, r2 && r2.length > 0 && import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: d2 }, import_react.default.createElement(
    M2,
    {
      direction: a2 ? "vertical" : "horizontal",
      gap: a2 ? "small" : "medium",
      appearance: d2
    },
    r2.map((n2) => {
      ...
      return import_react.default.createElement(
        $2,
        {
          key: n2,
          color: "default",
          icon: E2 ? import_react.default.createElement(E2, null) : "",
          loading: c2,
          onClick: () => g2(n2),
          appearance: d2
        },
        a2 && template((C2 = f2 == null ? void 0 : f2[w2]) == null ? void 0 : C2.social_provider_text, {
          provider: _2(n2)
        })
      );
    })
  )), !l2 && import_react.default.createElement(g1, { appearance: d2 })));
}
function q2({
  authView: s2 = "sign_in",
  defaultEmail: t2 = "",
  ...
  setDefaultEmail: l2 = (a2) => {
  },
  setDefaultPassword: w2 = (a2) => {
  },
  supabaseClient: f2,
  showLinks: d2 = false,
  redirectTo: c2,
  ...
  var R2, W2, O2, T2;
  const a2 = (0, import_react.useRef)(true), [g2, _2] = (0, import_react.useState)(t2), [n2, E2] = (0, import_react.useState)(r2), [C2, L2] = (0, import_react.useState)(""), [b2, V2] = (0, import_react.useState)(false), [N2, S2] = (0, import_react.useState)("");
  (0, import_react.useEffect)(() => (a2.current = true, _2(t2), E2(r2), () => {
    a2.current = false;
  }), [s2]);
  const X2 = async (y2) => {
    var G2;
    switch (y2.preventDefault(), L2(""), V2(true), s2) {
      case "sign_in":
        const { error: Z2 } = await f2.auth.signInWithPassword({
          email: g2,
          password: n2
        });
        Z2 && L2(Z2.message);
      ...
      case "sign_up":
        ...
        j2 ? L2(j2.message) : e1 && !t1 && S2((G2 = m2 == null ? void 0 : m2.sign_up) == null ? void 0 : G2.confirmation_text);
        break;
    }
    a2.current && V2(false);
  }, P2 = (y2) => {
    l2(g2), w2(n2), o2(y2);
  }, v2 = m2 == null ? void 0 : m2[s2];
  return import_react.default.createElement(
    "form",
    {
      id: s2 === "sign_in" ? "auth-sign-in" : "auth-sign-up",
      onSubmit: X2,
      autoComplete: "on",
      style: { width: "100%" }
    },
    import_react.default.createElement(M2, { direction: "vertical", gap: "large", appearance: i2 }, import_react.default.createElement(M2, { direction: "vertical", gap: "large", appearance: i2 }, import_react.default.createElement("div", null, import_react.default.createElement(D2, { htmlFor: "email", appearance: i2 }, v2 == null ? void 0 : v2.email_label), import_react.default.createElement(
      H2,
      {
        id: "email",
        type: "email",
        name: "email",
        autoFocus: true,
        placeholder: v2 == null ? void 0 : v2.email_input_placeholder,
        defaultValue: g2,
        onChange: (y2) => _2(y2.target.value),
        autoComplete: "email",
        appearance: i2
      }
    )), import_react.default.createElement("div", null, import_react.default.createElement(D2, { htmlFor: "password", appearance: i2 }, v2 == null ? void 0 : v2.password_label), import_react.default.createElement(
      H2,
      {
        id: "password",
        type: "password",
        name: "password",
        placeholder: v2 == null ? void 0 : v2.password_input_placeholder,
        defaultValue: n2,
        onChange: (y2) => E2(y2.target.value),
        autoComplete: s2 === "sign_in" ? "current-password" : "new-password",
        appearance: i2
      }
    ))), import_react.default.createElement(
      $2,
      ...
      b2 ? v2 == null ? void 0 : v2.loading_button_label : v2 == null ? void 0 : v2.button_label
    ), d2 && import_react.default.createElement(M2, { direction: "vertical", gap: "small", appearance: i2 }, s2 === VIEWS.SIGN_IN && u2 && import_react.default.createElement(
      B2,
      {
        href: "#auth-magic-link",
        onClick: (y2) => {
          y2.preventDefault(), o2(VIEWS.MAGIC_LINK);
        },
        appearance: i2
      },
      (R2 = m2 == null ? void 0 : m2.magic_link) == null ? void 0 : R2.link_text
    ), s2 === VIEWS.SIGN_IN && import_react.default.createElement(
      B2,
      {
        href: "#auth-forgot-password",
        onClick: (y2) => {
          y2.preventDefault(), o2(VIEWS.FORGOTTEN_PASSWORD);
        },
        appearance: i2
      },
      (W2 = m2 == null ? void 0 : m2.forgotten_password) == null ? void 0 : W2.link_text
    ), s2 === VIEWS.SIGN_IN ? import_react.default.createElement(
      B2,
      {
        href: "#auth-sign-up",
        onClick: (y2) => {
          y2.preventDefault(), P2(VIEWS.SIGN_UP);
        },
        appearance: i2
      },
      (O2 = m2 == null ? void 0 : m2.sign_up) == null ? void 0 : O2.link_text
    ) : import_react.default.createElement(
      B2,
      {
        href: "#auth-sign-in",
        onClick: (y2) => {
          y2.preventDefault(), P2(VIEWS.SIGN_IN);
        },
        appearance: i2
      },
      (T2 = m2 == null ? void 0 : m2.sign_in) == null ? void 0 : T2.link_text
    ))),
    N2 && import_react.default.createElement(z2, { appearance: i2 }, N2),
    C2 && import_react.default.createElement(z2, { color: "danger", appearance: i2 }, C2)
  );
}
function Y2({
  setAuthView: s2 = () => {
  ...
  const [f2, d2] = (0, import_react.useState)(""), [c2, u2] = (0, import_react.useState)(""), [m2, i2] = (0, import_react.useState)(""), [a2, g2] = (0, import_react.useState)(false), _2 = async (C2) => {
    var b2;
    C2.preventDefault(), u2(""), i2(""), g2(true);
    const { error: L2 } = await t2.auth.resetPasswordForEmail(f2, {
      redirectTo: r2
    });
    L2 ? u2(L2.message) : i2((b2 = o2 == null ? void 0 : o2.forgotten_password) == null ? void 0 : b2.confirmation_text), g2(false);
  }, n2 = o2 == null ? void 0 : o2.forgotten_password;
  return import_react.default.createElement("form", { id: "auth-forgot-password", onSubmit: _2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: l2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: l2 }, import_react.default.createElement("div", null, import_react.default.createElement(D2, { htmlFor: "email", appearance: l2 }, n2 == null ? void 0 : n2.email_label), import_react.default.createElement(
    H2,
    {
      id: "email",
      name: "email",
...
function J2({
  ...
  const [o2, l2] = (0, import_react.useState)(""), [w2, f2] = (0, import_react.useState)(""), [d2, c2] = (0, import_react.useState)(""), [u2, m2] = (0, import_react.useState)(false), i2 = async (g2) => {
    var n2;
    g2.preventDefault(), f2(""), c2(""), m2(true);
    const { error: _2 } = await s2.auth.updateUser({ password: o2 });
    _2 ? f2(_2.message) : c2((n2 = t2 == null ? void 0 : t2.update_password) == null ? void 0 : n2.confirmation_text), m2(false);
  }, a2 = t2 == null ? void 0 : t2.update_password;
  return import_react.default.createElement("form", { id: "auth-update-password", onSubmit: i2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: r2 }, import_react.default.createElement(M2, { gap: "large", direction: "vertical", appearance: r2 }, import_react.default.createElement("div", null, import_react.default.createElement(D2, { htmlFor: "password", appearance: r2 }, a2 == null ? void 0 : a2.password_label), import_react.default.createElement(
    H2,
    {
      id: "password",
      name: "password",
      placeholder: a2 == null ? void 0 : a2.password_label,
      type: "password",
      autoFocus: true,
      onChange: (g2) => l2(g2.target.value),
      appearance: r2
    }
  )), import_react.default.createElement(
    $2,
    ...
    u2 ? a2 == null ? void 0 : a2.loading_button_label : a2 == null ? void 0 : a2.button_label
  )), d2 && import_react.default.createElement(z2, { appearance: r2 }, d2), w2 && import_react.default.createElement(z2, { color: "danger", appearance: r2 }, w2)));
}
var Q = (0, import_react.createContext)({ user: null, session: null });
var $1 = (s2) => {
  const { supabaseClient: t2 } = s2, [r2, o2] = (0, import_react.useState)(null), [l2, w2] = (0, import_react.useState)((r2 == null ? void 0 : r2.user) ?? null);
  (0, import_react.useEffect)(() => {
    (async () => {
      var u2;
      const { data: c2 } = await t2.auth.getSession();
      o2(c2.session), w2(((u2 = c2.session) == null ? void 0 : u2.user) ?? null);
    })();
    const { data: d2 } = t2.auth.onAuthStateChange(
      async (c2, u2) => {
        o2(u2), w2((u2 == null ? void 0 : u2.user) ?? null);
      }
    );
    return () => {
      d2 == null || d2.subscription.unsubscribe();
    };
  }, []);
  const f2 = {
    session: r2,
  ...
  return import_react.default.createElement(Q.Provider, { value: f2, ...s2 });
};
var I1 = () => {
  const s2 = (0, import_react.useContext)(Q);
  if (s2 === void 0)
...
function I2({
  ...
  view: o2 = "sign_in",
  redirectTo: l2,
  onlyThirdPartyProviders: w2 = false,
  magicLink: f2 = false,
  showLinks: d2 = true,
  appearance: c2,
  theme: u2 = "default",
  localization: m2 = { variables: {} }
}) {
  const i2 = merge(en_default, m2.variables ?? {}), [a2, g2] = (0, import_react.useState)(o2), [_2, n2] = (0, import_react.useState)(""), [E2, C2] = (0, import_react.useState)(""), L2 = a2 === "sign_in" || a2 === "sign_up";
  (0, import_react.useEffect)(() => {
    var N2, S2;
    X({
      theme: merge(
        ((N2 = c2 == null ? void 0 : c2.theme) == null ? void 0 : N2.default) ?? {},
        ((S2 = c2 == null ? void 0 : c2.variables) == null ? void 0 : S2.default) ?? {}
      )
    });
  }, [c2]);
  const b2 = ({ children: N2 }) => {
    var S2;
    return (
      // @ts-ignore
      import_react.default.createElement(
        "div",
        {
          className: u2 !== "default" ? q(
            merge(
              // @ts-ignore
              c2 == null ? void 0 : c2.theme[u2],
              ((S2 = c2 == null ? void 0 : c2.variables) == null ? void 0 : S2[u2]) ?? {}
            )
          ) : ""
        },
        L2 && import_react.default.createElement(
          D1,
          {
            appearance: c2,
            supabaseClient: s2,
  ...
  (0, import_react.useEffect)(() => {
    const { data: N2 } = s2.auth.onAuthStateChange(
      (S2) => {
        S2 === "PASSWORD_RECOVERY" ? g2("update_password") : S2 === "USER_UPDATED" && g2("sign_in");
      }
    );
    return g2(o2), () => N2.subscription.unsubscribe();
  }, [o2]);
  const V2 = {
    supabaseClient: s2,
    setAuthView: g2,
  ...
  switch (a2) {
    case VIEWS.SIGN_IN:
      return import_react.default.createElement(b2, null, import_react.default.createElement(q2, { ...V2, authView: "sign_in" }));
    case VIEWS.SIGN_UP:
      return import_react.default.createElement(b2, null, import_react.default.createElement(
        q2,
        {
          appearance: c2,
          supabaseClient: s2,
...
I2.ForgottenPassword = Y2;
I2.UpdatePassword = J2;
I2.MagicLink = K;
I2.UserContextProvider = $1;
I2.useUser = I1;
export {
  I2 as Auth,
  q2 as EmailAuth,
  Y2 as ForgottenPassword,
  K as MagicLink,
  D1 as SocialAuth,
  J2 as UpdatePassword
};
